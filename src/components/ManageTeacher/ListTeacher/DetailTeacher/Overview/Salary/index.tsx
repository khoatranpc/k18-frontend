...
const Salary = () => {
    ...
    const [modalSalary, setModalSalary] = useState<{
        ...
        currentSalary: getListSalary[getListSalary.length - 1]?.rank as number || 0,
    ...
    return (
        <div className={styles.salary}>
            ...
            <Table
                ...
                rowData={rowData}
            />
            {modalSalary.show && <ModalCustomize
                centered
                ...
                modalHeader={<h3>{modalSalary.typeModel === 'ADD' ? 'Thêm mức lương' : 'Cập nhật mức lương'}</h3>}
            >
                <PopupSalary listSalary={getListSalary} idSalary={modalSalary.idSalary} currentSalary={modalSalary.currentSalary} type={modalSalary.typeModel} />
            </ModalCustomize>}
        </div>
    )
}
